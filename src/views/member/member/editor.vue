    ...
    <el-drawer v-model="state.isShow" :size='480' :title="(state.data.id!==''?'修改':'添加')+'客户'">
      <div style="padding: 0 20px">
        <el-form :model="state.data" ref="formRef" :rules="state.rules" size="default" label-width="100px">
          ...
          <el-form-item required :inline="true" label="客户姓名" prop="name">
            <el-input v-model="state.data.name" placeholder="请输入客户姓名" class="w100"/>
          </el-form-item>
          <el-form-item required :inline="true" label="客户称谓" prop="title">
            <el-input v-model="state.data.title" placeholder="请输入客户称谓" class="w100"/>
          </el-form-item>
          ...
          <el-form-item :inline="true" label="客户标签" prop="tags">
            <el-input v-model="state.data.tags" placeholder="请输入客户标签" class="w100"/>
          </el-form-item>
          ...
          <el-form-item :inline="true" label="客户介绍" prop="brief">
            <el-input v-model="state.data.brief" autosize type="textarea" placeholder="请输入客户介绍" class="w100"/>
          </el-form-item>
...
import {MemberData, MemberEditor, UploadResult} from "/@/views/member/member/dataType";
...
// 打开弹窗
const openEditor = (row?: MemberData, clinic?: Array<ClinicData>) => {
  resetForm();
  if (row) {
    state.data = row;
  }
