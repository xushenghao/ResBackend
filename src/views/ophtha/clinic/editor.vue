<template>
  <div class="system-edit-job-container">
    <el-dialog :title="(jobForm.jobId!==0?'修改':'添加')+'诊所'" v-model="isShowDialog" width="800px">
      <el-form :model="jobForm" ref="formRef" :rules="rules" size="default" label-width="100px">
        <el-row>
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <el-form-item :inline="true" label="诊所名称" prop="jobName">
              <el-input v-model="jobForm.jobName" placeholder="请输入诊所名称" class="w100"/>
            </el-form-item>
          </el-col>

          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <el-form-item :inline="true" label="诊所分组" prop="jobGroup">
              <el-select v-model="jobForm.jobGroup" placeholder="请选择诊所分组" class="w100">
                <el-option
      ...
      <template #footer>
				<span class="dialog-footer">
					...
					<el-button type="primary" @click="onSubmit" size="default">{{ jobForm.jobId !== 0 ? '修 改' : '添 加' }}</el-button>
				</span>
      </template>
    </el-dialog>
  </div>
