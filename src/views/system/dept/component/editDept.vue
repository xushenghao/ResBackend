<template>
  <div class="system-edit-dept-container">
    <el-dialog :title="(deptForm.deptId!==0?'修改':'添加')+'机构'" v-model="isShowDialog" width="769px">
      <el-form ref="formRef" :model="deptForm" :rules="rules" size="default" label-width="90px">
        <el-row :gutter="35">
      ...
      <template #footer>
				<span class="dialog-footer">
					...
					<el-button type="primary" @click="onSubmit" size="default">{{ deptForm.deptId !== 0 ? '修 改' : '添 加' }}</el-button>
				</span>
      </template>
    </el-dialog>
  </div>
