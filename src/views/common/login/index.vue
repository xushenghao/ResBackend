...
import Account from '/@/views/common/login/component/account.vue';
import Mobile from '/@/views/common/login/component/mobile.vue';
import Scan from '/@/views/common/login/component/scan.vue';
