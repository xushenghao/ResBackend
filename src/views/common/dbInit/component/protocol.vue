<template>
  <el-card class="box-card">
    ...
    <div class="content">
      <p>软件使用协议</p>
      <h3>免责声明：</h3>
      <p>1、仅限自己学习使用，一切商业行为与本开发平台无关。</p>
      <p>2、用户不得利用本开发平台从事非法行为，用户应当合法合规的使用，发现用户在使用产品时有任何的非法行为，本开发平台有权配合有关机关进行调查或向政府机构举报，本开发平台不承担用户因非法行为造成的任何法律责任，一切法律责任由用户自行承担，如因用户使用造成第三方损害的，用户应当依法予以赔偿。</p>
      <p>3、所有与使用本开发平台相关的资源直接风险均由用户承担。</p>

      <h3>商用说明</h3>
      <p>商用注意事项</p>
      <p>如果您将此项目用于商业用途，请遵守Apache2.0协议并保留作者技术支持声明。</p>
      <p>● 本快速开发平台采用Apache-2.0技术协议</p>
      <p>● 二次开发如用于商业性质或开源竞品请保留版权信息</p>
      <p>● 允许进行商用，但是不允许二次开源出来并进行收费</p>
      <p>● 请不要删除和修改本开发平台源码头部的版权与作者声明及出处，若需修改或删除联系群主授权</p>
