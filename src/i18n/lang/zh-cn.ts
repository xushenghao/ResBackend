...
export default {
	...
	layout: {
		...
		threeIsFixedHeader: '固定页眉',
		threeIsClassicSplitMenu: '经典布局分割菜单',
		threeIsLockScreen: '开启锁屏',
		threeLockScreenTime: '自动锁屏(s/秒)',
		fourTitle: '界面显示',
		fourIsShowLogo: '侧边栏标志',
		fourIsBreadcrumb: '开启面包屑',
		fourIsBreadcrumbIcon: '开启面包屑图标',
		fourIsTagsview: '开启标签视图',
		fourIsTagsviewIcon: '开启标签视图图标',
		fourIsCacheTagsView: '开启标签视图缓存',
		fourIsSortableTagsView: '开启标签视图拖拽',
		fourIsShareTagsView: '开启标签视图共用',
		fourIsFooter: '开启页脚',
